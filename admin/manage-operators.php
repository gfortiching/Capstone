                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Operator Status</th>
                            <th class="font-weight-bold">Operator Name</th>
                            <th class="font-weight-bold">Operator Email</th>
...
$sql="SELECT tbl_operators.OperatorID,tbl_operators.ID as sid,tbl_operators.OperatorName,tbl_operators.OperatorEmail,tbl_operators.DateofAdmission,tblclass.ClassName,tblclass.Section from tbl_operators join tblclass on tblclass.ID=tbl_operators.OperatorClass LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td><?php  echo htmlentities($row->OprID);?></td>
